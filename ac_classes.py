...
class MultiDataModel():
    ...
    def x_stats(self):
        self.no_of_indep_var = len(x)
        self.x_mean = [st.mean(i) for i in x]
        self.x_var = [st.variance(i) for i in x]
        self.x_std_dev = [math.sqrt(st.variance(i)) for i in x]

    def y_stats(self):
        self.y_mean = st.mean(y)
        self.y_var = st.variance(y)
        self.y_std_dev = math.sqrt(st.variance(y))
